...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Teacher endpoints (Let the controller do the checking!)
                        .requestMatchers("/api/teacher/**").authenticated()

                        // Student endpoints (Let the controller do the checking!)
                        .requestMatchers("/api/students/**", "/api/attendance/**").authenticated()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList(
                ...
                "http://localhost:5173",
                "http://localhost:5174",
                "https://qr-attendance-frontend-two.vercel.app"
        ));
